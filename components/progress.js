...
const properties = {}
// UI.attributes(UIProgress, 'min', 'max', 'value', 'mode', 'color', 'background', 'size', 'angle', 'low', 'high', 'optium', 'stroke', 'speed');
// UI.properties(UIProgress, 'disabled', 'linear', 'fill', 'reverse');
...
/** {UIProgress} @class
  ...
  */
  ...
  /** Создание элемента в DOM (DOM доступен) / mount @lifecycle
    ...
    * @return {Component} @this {UIProgress} текущий компонент
    */
    mount(node) {
